...
<?php
  	if (isset($_GET['idreligion'])) {
		$id = $_GET['idreligion'];
        $getBookByIdReligion = $book->getBookByIdReligion($id);
			...
			<main id="main" class="site-main" role="main">
				...
				<div class="row"> 
					...
					<!--  -->
						...
						<?php
						if ($getBookByIdReligion) {
							$i = 0;
							while ($result = $getBookByIdReligion->fetch_assoc()) {
								$i++;
								...
								<div class="newspaper-x-post-meta">
									<div>
										<span class="newspaper-x-category"> 
											<a href="#"><i class="fa fa-cart-plus" aria-hidden="true"> Best seller</i></a>
										</span>
                                        &nbsp;
                                        <span class="newspaper-x-category"> 
											<a href="#"><i class="fa-solid fa-tag"></i> <?=$result['price']?>đ</a>
										</span>
                                        &nbsp;
                                        <span class="newspaper-x-category"> 
											<a href="#"><?=$result['religioname']?></i></a>
										</span>
