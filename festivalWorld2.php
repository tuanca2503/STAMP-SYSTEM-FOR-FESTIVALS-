...
?>
<?php
	$WorldFestivalPage2 = $worldfestival->WorldFestivalPage2();
?>
<div class="container">
	<div id="primary" class="newspaper-x-content newspaper-x-archive-page col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<main id="main" class="site-main" role="main">
			...
			<div class="row">
				<?php
                    if ($WorldFestivalPage2) {
                        $i=0;
                        while ($result =$WorldFestivalPage2->fetch_assoc()) {
                            $i++; ?>
				<div class="col-md-6">
		...
		<nav class="navigation posts-navigation" aria-label="Posts">
					...
					<div class="nav-links">
						<div class="nav-previous">
							<a href="festivalWorld1.php"><i class="fa-solid fa-arrow-left"></i> Previous Post </a>
						</div>
						<div class="nav-next">
							<a href="festivalWorld3.php">Next Post <i class="fa-solid fa-arrow-right"></i></a>
						</div>
					</div>
				</nav>
		<!-- ------------------------------ -->
